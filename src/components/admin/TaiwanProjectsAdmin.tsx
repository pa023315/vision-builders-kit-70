...
export const TaiwanProjectsAdmin = () => {
  ...
  const handleBulkDelete = () => {
    if (confirm(`確定要刪除所有台灣專案嗎？`)) {
      taiwanProjects.forEach(project => {
                      ...
                      <div>
                        ...
                        >
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="flyingV">flyingV</SelectItem>
                            <SelectItem value="HereO">HereO</SelectItem>
                            <SelectItem value="群募貝果">群募貝果</SelectItem>
